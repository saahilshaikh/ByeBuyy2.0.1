...
export default class ViewProductScreen extends React.Component {
    ...
    async componentDidMount(){
        if (this.props.route.params && this.props.route.params.screen !== undefined) {
            var id=this.props.route.params.screen;
        }
        else{
            var id = this.props.route.state ? this.props.route.state.routes[0].name : this.props.route.params.id;
        }
        ...
        if (auth().currentUser) {
            ...
            if (res3.data !== null) {
                ...
                this.setState({
                    ...
                    like:auth().currentUser? product.likes.includes(auth().currentUser.email):false,
                    save:auth().currentUser? product.saves.includes(auth().currentUser.email):false,
                })
            }
        }
    }
                    ...
                    if (this.state.tab === 1) {
                        ...
                        if(resDeal.data!==null)
                        {
                            ...
                            if(resDeal.data.type==='success')
                            {
                                ...
                                this.props.navigation.navigate('Chat', { id: id, location: this.props.route.params.location });
                            }
                            else{
                                Snackbar.show({
                                        ...
                                        <View style={styles.item}>
                                            <View style={styles.top}>
                                                <View style={styles.profile}>
                                                    <TouchableOpacity onPress={() => this.props.navigation.navigate('viewProfile', { id: this.state.owner.id })} style={styles.profileBox}>
                                                        {
                                                ...
                                                <ScrollView
                                                    ...
                                                    style={{ marginVertical: 10 }}>
                                                    {
                                                        this.state.product.images.length > 1
                                                            ...
                                                            <>
                                                                {
                                                                    this.state.product.images.map((image, index) => {
                                                                        return (
                                                                            <TouchableOpacity key={index} onPress={() => this.handleCardImageClick(this.state.product.images, image.index)} style={styles.imageBox}>
                                                                                <Image
                                                            ...
                                                            :
                                                            <TouchableOpacity onPress={() => this.handleCardImageClick(this.state.product.images, this.state.product.images[0].index)} style={styles.imageBoxOne}>
                                                                <Image
                                        ...
                                        <>
                                            {
                                                this.state.product.owner === auth().currentUser.email
                                                    ...
                                                    <View style={styles.requestContainer}>
                                                        ...
                                                        {this.state.product.quantity===0?<View style={styles.crossbar}></View>:null}
                                                    </View>
                                            }
                                        </>
                                        :
                    ...
                    <View
                        ...
                        <View
                            ...
                            <View style={{ width: '100%', marginTop: 10 }}>
                                <View style={{ width: '100%', paddingTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>

                                    {
                                        this.state.product.type === 'exchange'
                                            ?
                                            <View style={{ width: '90%', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 10 }}>
                                                <TouchableOpacity
                                                    onPress={() => this.setState({
                                                        tab: 1
                                                    })}
                                                    style={this.state.tab === 1 ? styles.activeTab : styles.inactiveTab}>
                                                    <Text
                                                        style={{
                                                            fontFamily: 'Muli-Bold',
                                                            color: colors.white,
                                                ...
                                                <TouchableOpacity
                                                    ...
                                                    style={this.state.tab === 2 ? styles.activeTab : styles.inactiveTab}>
                                                    <Text
                                                        style={{
                                                            fontFamily: 'Muli-Bold',
                                                            color: colors.white,
                                ...
                                <View style={{ width: '100%', alignItems: 'center' }}>
                                    ...
                                    {
                                        this.state.tab === 2 && this.state.product.type === 'exchange'
                                            ?
                                            <View style={{ width: '100%', alignItems: 'center', height: height * 0.6 }}>
                                                <ScrollView style={{ width: '100%', flex: 1, paddingVertical: 10 }}>
                                                    {
                                                        this.state.productList.map(product => {
                                                                return (
                                                                                <TouchableOpacity onPress={() => this.handleSelectCard(product._id)} style={styles.activeproduct}>
                                                                                    <Card3 key={product._id} handleCardImageClick={(e, f) => this.handleCardImageClick(e, f)}
                                                                                        id={product._id}
                                                                                        navigation={this.props.navigation} />
                                                                                    {
                                                                                        ...
                                                                                        ?
                                                                                        <>
                                                                                        <View style={styles.activeproductOverlay}>
                                                                                    </View>
                                                                                    <Ionicons
                                    ...
                                    <TouchableOpacity style={styles.requestButton} onPress={this.handleRequestProduct}>
                ...
                <Modal isVisible={this.state.reportForm}>
                    <View
                        ...
                        <View
                            ...
                            <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', borderBottomColor: colors.grey, borderBottomWidth: StyleSheet.hairlineWidth, paddingVertical: 10 }}>
                                <TouchableOpacity style={{ marginLeft: 20 }} onPress={() => this.setState({
                                    reportForm: false
                                })}>
