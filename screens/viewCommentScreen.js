...
export default class ViewCommentScreen extends React.Component {
    ...
    handleChange = async (e) => {
        ...
        if (this.state.pos !== null) {
            ...
            var search = e.substring(this.state.pos + 1, e.indexOf(" ", this.state.pos + 1));
    ...
    handleTag = (e) => {
        ...
        var end = this.state.comment.substr(this.state.pos + this.state.search.length + 1, this.state.comment.length)
                        ...
                        <View style={styles.commentContainer}>
                            <View style={styles.inputContainer}>
                                <TextInput
                                    ...
                                    maxLength={150} placeholder="Type a comment ..." />
                            </View>
                            {
                                this.state.commenting
                                    ...
                                    :
                                    <TouchableOpacity onPress={this.handleComment} style={styles.bottomButton}>
