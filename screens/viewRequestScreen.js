                                    ...
                                    <View
                                        ...
                                        <View style={styles.item}>
                                                                                ...
                                                                                auth().currentUser.email === this.state.product.owner
                                                                                    ...
                                                                                    <View style={styles.tagBox}>
                                                                                        <Ionicons
                                                                                            ...
                                                                                            color={colors.white}
                                                                                        />
                                                                                        <Text style={styles.tag}>{this.state.product.tag}</Text>
                                                                                    </View>
                                                                            }
                                                                        </>
                                                                        :
                                            ...
                                            <View style={styles.middle}>
                                                ...
                                                <Text onPress={() => this.props.navigation.navigate('viewRequest', { id: this.props.item.id })} style={styles.title}>{this.state.product.description}</Text>
                                            </View>
                        ...
                        <View style={{ width: '100%', alignItems: 'center', flex: 1 }}>
                            {
                                this.state.tags && this.state.tags.map(tag => {
                                    return (
                                        <TouchableOpacity onPress={() => this.handleTag(tag)} style={{ width: '90%', alignItems: 'center', flexDirection: 'row', marginVertical: 10 }}>
                                            <View style={styles.profileBox}>
                                                {
                                                    tag.photo
                                                        ...
                                                        :
                                                        <View style={styles.profileImageBox}>
                                                            <Text style={styles.imageText}>{tag.name.charAt(0).toUpperCase()}</Text>
                                                        </View>
                                                }
                                            </View>
                                            <View>
