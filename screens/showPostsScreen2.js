...
export default class ShowPostsScreen2 extends React.Component {
    constructor() {
        super();
        this.state = {
            data: [],
    ...
    handleInit =async () => {
        ...
        var res=await axios.post(link+'/api/request/what',data);
        if(res.data!==null)
        {
            this.setState({
                data:res.data,
    ...
    handleLocation = async (city, country) => {
    ...
    handleReachedEnd = () => {
      ...
      handleViewMore = async () => {
        ...
        var res = await axios.post(link + '/api/request/whatNext10', data);
        if (res.data!==null) {
          this.setState({
            loadingMore: false
          })
        ...
        return (
          <View style={{ width: '100%' }}>
            <View
              ...
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate('Loc', { handleLocation: this.handleLocation })}
                style={{
                  flexDirection: 'row',
                  alignItems: 'center',
                    ...
                    !this.state.loading
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <Card2 key={item.id}
                                    item={item}
                                    handleCardImageClick={(e, f) => this.props.handleCardImageClick(e, f)}
