            ...
            <View
              ...
              {this.props.route.params.item.varient === 'exchange' ? (
                <View
                  ...
                  <MiniCard
                    id={this.props.route.params.item.id2}
                    navigation={this.props.navigation}
                  />
                </View>
              ) : (
              ...
              <View style={{width: '90%', paddingVertical: 10}}>
                ...
                <View
                  ...
                  <Text style={styles.dlogHead}>:</Text>
                  <Text style={styles.dlogDate}>
                    {this.props.route.params.item.meeting.landmark}
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <Text style={styles.dlogHead}>:</Text>
                  <Text style={styles.dlogDate}>
                    {this.props.route.params.item.meeting.location}
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <Text style={styles.dlogHead}>:</Text>
                  <Text style={styles.dlogDate}>
                    {this.props.route.params.item.meeting.date}
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <Text style={styles.dlogHead}>:</Text>
                  <Text style={styles.dlogDate}>
                    {this.props.route.params.item.meeting.time}
                  </Text>
                </View>
              </View>
            </View>
