                                            ...
                                            <View style={styles.item}>
                                                <View style={styles.top}>
                                                    <View style={styles.profile}>
                                                        <TouchableOpacity onPress={() => this.props.navigation.navigate('viewProfile', { id: this.state.owner._id })} style={styles.profileBox}>
                                                            {
                                                        ...
                                                        <View>
                                                            <Text onPress={() => this.props.navigation.navigate('viewProfile', { id: this.state.owner._id })} style={styles.profileName}>{this.state.owner.name}</Text>
                                                            <Text onPress={() => this.props.navigation.navigate('viewProfile', { id: this.state.owner._id })} style={styles.profileUName}>@{this.state.owner.uname}</Text>
                                                ...
                                                <Text style={styles.type}>{this.state.product.type}</Text>
                                                    ...
                                                    <Text onPress={() => this.props.navigation.navigate('viewRequest', { id: this.state.product.id, location: this.props.location })} style={styles.title}>{this.state.product.description}</Text>
                                                </View>
                                            </View>
                                        </View>
