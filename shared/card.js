                    ...
                    if (this.state.tab === 1) {
                        ...
                        if(resDeal.data!==null)
                        {
                            ...
                            if(resDeal.data.type==='success')
                            {
                                ...
                                this.props.navigation.navigate('Chat', { id: id, location: this.props.location });
                            }
                            else{
                                Snackbar.show({
                                        ...
                                        <View style={{ width: '100%', alignItems: 'center' }}>
                                            <View style={styles.item}>
                                                ...
                                                {this.state.product.type === 'share' ? (
                                                        ...
                                                        <TouchableOpacity onPress={()=>this.setState({viewmore:!this.state.viewmore})}><Text style={styles.viewMoreText}>{this.state.viewmore?'view less':'view more'}</Text></TouchableOpacity>
                                                    </View>
                                                    <ScrollView
                                                        horizontal={true}
                                                                ...
                                                                <>
                                                                    {
                                                                        this.state.product.images.map((image, index) => {
                                                                            return (
                                                                                <TouchableOpacity onPress={() => this.handleCardImageClick(this.state.product.images, image.index)} key={index} style={styles.imageBox}>
                                                                                    <Image
                                                ...
                                                auth().currentUser && this.state.product.owner === auth().currentUser.email
                                                    ...
                                                    <TouchableOpacity
                                                        onPress={() => {
                                                            ...
                                                            this.props.navigation.navigate('EditItem', { id: this.state.product.id })
                                                        }}
                                                        style={{
                                                            width: '100%',
                                                            flexDirection: 'row',
                                                                ...
                                                                return (
                                                                                <TouchableOpacity onPress={() => this.handleSelectCard(product._id)} style={styles.activeproduct}>
                                                                                        ...
                                                                                        navigation={this.props.navigation} />
                                                                                    {
                                                                                        ...
                                                                                        ?
                                                                                        <>
                                                                                        <View style={styles.activeproductOverlay}></View>
                                                                                        <Ionicons
