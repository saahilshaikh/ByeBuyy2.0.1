                            ...
                            <View
                                ...
                                <View style={styles.item}>
                                    <View style={styles.profile}>
                                        <TouchableOpacity onPress={() => this.props.navigation.push('viewProfile', { id: this.state.user.id,location:location })} style={styles.profileBox}>
                                            {
                                                        ...
                                                        <View style={styles.actionProfile}>
                                                            {
                                                                this.state.follow
                                                                    ...
                                                                    <TouchableOpacity onPress={this.handleFollow} style={styles.followAction}>
                                                                        <Ionicons name='ios-person-remove' size={16} color={colors.white} style={{ marginRight: 7 }} />
                                                                        <Text style={styles.followActionText}>Unfollow</Text>
                                                                    </TouchableOpacity>
                                                                    :
                                                                    <TouchableOpacity onPress={this.handleFollow} style={styles.followAction}>
                                                                        <Ionicons name='ios-person-add' size={16} color={colors.white} style={{ marginRight: 7 }} />
